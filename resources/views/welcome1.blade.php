    ...
    <div class="ts-page-wrapper" id="page-top">
        ...
        <header id="ts-hero" class="ts-full-screen ts-separate-bg-element">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark fixed-top ts-separate-bg-element" data-bg-color="#141a3a">
                <div class="container">
                    <a class="navbar-brand" href="#page-top">
                        <img src="{{ asset('front/assets/img/logo-w.png')}}" alt="">
                    </a>
                    <!--end navbar-brand-->
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav ml-auto">
                           ...
                           {{--<a class="nav-item nav-link ts-scroll" href="#pricing">Pricing</a>
                            ...
                            @if (Route::has('login'))
                                @auth
                        <a class="ts-scroll btn btn-primary btn-sm m-1 px-3 ts-width__auto" href="{{ route('home')}}">Dashboard</a>
                                @else
                                <a class="ts-scroll btn btn-primary btn-sm m-1 px-3 ts-width__auto" href="{{ route('login')}}">Login</a>
                                  @endauth
                            @endif
            ...
            <div class="ts-background" data-bg-color="#141a3a" data-bg-parallax="scroll" data-bg-parallax-speed="3">
                <div class="ts-background-image ts-svg ts-z-index__1 ts-background-position-left d-none d-md-block" data-bg-image="{{ asset('front/assets/svg/shape-mask.svg')}}" data-animate="ts-fadeInLeft"></div>
                <div class="ts-background-image ts-parallax-element" data-bg-image="{{ asset('front/assets/img/bg-man-sitting.jpg')}}" data-animate="ts-zoomOutIn"></div>
            </div>
            <!--END HERO BACKGROUND *********************************************************************************-->
